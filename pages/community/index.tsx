...
const Commmunity: NextPage = () => {
  return (
    <div className="py-16  px-4 space-y-8">
      ...
      <button className="fixed bottom-24 right-5 bg-orange-400 rounded-full shadow-xl p-4 text-white hover:bg-orange-500 transition-colors cursor-pointer">
        <svg
          className="w-6 h-6"
          fill="none"
          stroke="currentColor"
